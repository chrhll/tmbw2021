const offers = [{
  ...
  "id": ["S_02", "S_03", "S_04"],
  "city": ["Stuttgart", "Stuttgart", "Stuttgart"],
  "type": ["Stadtführung", "Tageserlebnis", "Kultur", "Wein"],
  "people": ["Zu zweit", "Einzeln", "Gruppe", "Familie"],
