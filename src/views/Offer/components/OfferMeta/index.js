      ...
      <div className="tmbw-sharing-widget" onClick={e => waitAndHide(e)}>
        <div className="tmbw-sharing-widget-inner">
          <div className="tmbw-sharing-widget-icons">
            <a target="_blank"
              rel="noreferrer"
              href={`http://twitter.com/share?text==Schaut mal was ich gefunden habe: ${props.offer.title} - ${window.location.href}&url=${window.location.href}`}>
  ...
  return (
    <div className="tmbw-offer-meta">
      ...
      <div className="tmbw-offer-sponsor">
        ...
        <a href={`/?tmbw-city=${props.offer.city}`} className="tmbw-offer-sponsor-note">
